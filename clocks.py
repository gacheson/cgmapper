...
# Customize these
card = '0,1'       # Card number, 0 is the first
mem_min = '1400,1400' # The memory clock to start at
mem_max = '1500,1500' # The memory clock to end at
mem_step = '3'   # The interval to try memory clocks at (1 = all, 2 = every other, etc.)
core_min = '1075,975' # The core clock to start at
core_max = '1100,1050' # The core clock to end at
